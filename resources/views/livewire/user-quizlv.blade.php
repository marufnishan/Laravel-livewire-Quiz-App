    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-lg mt-6">
        <form id="myForm" wire:submit.prevent>
            ...
            <div class="flex items-center justify-end mt-4">
                @if($count < $quizSize) <button wire:click="nextQuestion" type="button" @if($isDisabled) disabled='disabled' @endif class="m-4 inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring focus:ring-gray-300 disabled:opacity-25 transition">
                    {{ __('Next Question') }}
                    </button>
                    <button type="button" @if($isDisabled) disabled='disabled' @endif wire:click="submitreasult" class="m-4 inline-flex items-center px-4 py-2 bg-green-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-300 active:bg-indigo-500 focus:outline-none focus:bg-indigo-500 focus:ring focus:bg-indigo-500 disabled:opacity-25 transition">Submit Your Answer</button>
                    @else
                    <button wire:click="nextQuestion" type="button" @if($isDisabled) disabled='disabled' @endif class="m-4 inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring focus:ring-gray-300 disabled:opacity-25 transition">
                        {{ __('Show Results') }}
                    </button>
